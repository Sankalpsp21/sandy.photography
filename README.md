...
4. THE Website SHALL use a design system based on Radix UI primitives with a neutral, minimal color palette consistent with Apple's Human Interface Guidelines.
...
1. THE Image_CDN SHALL serve photos in modern formats (WebP or AVIF) with automatic format negotiation based on browser support.
